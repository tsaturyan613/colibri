    ...
    jQuery.extend(!0, b, {
        checkForParallax: function(a, e) {
            ...
            if (!f.done) {
                ...
                e.c.find(".tp-revslider-slidesli .slotholder, .tp-revslider-slidesli .rs-background-video-layer").each(function() {
                    ...
                    void 0 !== (b = "on" == b ? 1 : b) && "off" !== b && (f.bgcontainers.push(a),
        ...
        scrollHandling: function(a, d, f) {
            ...
            h.enable) {
                ...
                1 - h.visible_area <= k ? a.inviewport || (a.inviewport = !0,
                b.enterInViewPort(a)) : a.inviewport && (a.inviewport = !1,
                b.leaveViewPort(a))
            }
            if (c && "on" == i.disable_onmobile)
                return !1;
            ...
            if (s.on && ("on" !== s.disable_on_mobile || !c)) {
                ...
                !1 !== s.layers) {
                    ...
                    if ("on" === s.grayscale) {
                        var y = 100 * (1 - u)
                          , z = "grayscale(" + y + "%)";
                        v["-webkit-filter"] = void 0 === v["-webkit-filter"] ? z : v["-webkit-filter"] + " " + z,
