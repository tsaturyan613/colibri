...
!function($) {
    ...
    function getScrollRoot() {
        var d, a = document.documentElement, b = document.body, c = (void 0 !== window.pageYOffset ? window.pageYOffset : null) || b.scrollTop || a.scrollTop;
    ...
    jQuery.extend(!0, _R, {
        checkActions: function(a, b, c) {
            if ("stop" === _R.compare_version(extension).check)
                return !1;
    ...
    var checkActions_intern = function(a, b, c) {
        c && jQuery.each(c, function(c, d) {
            ...
            switch (-1 != jQuery.inArray(d.action, ["toggleslider", "toggle_mute_video", "toggle_global_mute_video", "togglefullscreen"]) && a.data("togglelisteners", !0),
            d.action) {
            case "togglevideo":
      ...
      , actionSwitches = function(tnc, opt, a, _nc) {
        ...
        case "toggle_mute_video":
            ...
            break;
        case "toggle_global_mute_video":
            !0 === opt.globalmute ? (opt.globalmute = !1,
