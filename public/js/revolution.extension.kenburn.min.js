    ...
    jQuery.extend(!0, b, {
        ...
        startKenBurn: function(a, d, e) {
            ...
            "carousel" === d.sliderType ? d.carousel.slide_width : d.ul.width())
              , k = d.ul.height();
            if (a.data("kbtl") && a.data("kbtl").kill(),
            e = e || 0,
            0 == a.find(".tp-kbimg").length) {
                var m = g.data("mediafilter");
                m = void 0 === m ? "" : m,
                a.append('<div class="tp-kbimg-wrap ' + m + '" style="z-index:2;width:100%;height:100%;top:0px;left:0px;position:absolute;"><img class="tp-kbimg" src="' + h + '" style="position:absolute;" width="' + f.owidth + '" height="' + f.oheight + '"></div>'),
            ...
            var n = function(a, b, c, d, e, f, g) {
              ...
              , o = function(a, b, c, d, e) {
                ...
                var i = new Object;
                return i.start = n(e.start.width, e.start.height, e.start.scale, b, c, g, h),
