...
!function(jQuery, undefined) {
        ...
        revolution: function(a) {
            ...
            this.each(function() {
                ...
                jQuery(this).on("scriptsloaded", function() {
                    if (a.modulesfailing)
                        return b.html('<div style="margin:auto;line-height:40px;font-size:14px;color:#fff;padding:15px;background:#e74c3c;margin:20px 0px;">!! Error at loading Slider Revolution 5.0 Extrensions.' + a.errorm + "</div>").show(),
                        !1;
    ...
    jQuery.extend(!0, _R, {
        ...
        compare_version: function(a) {
            ...
            b.Core === undefined && (b.Core = new Object,
            b.Core.alias = "Slider Revolution Core",
            b.Core.name = "jquery.themepunch.revolution.min.js",
            b.Core.ver = _R.getversion().core),
            "stop" != a.check && (_R.getversion().core < a.min_core ? (a.check === undefined && (console.log("%cSlider Revolution Warning (Core:" + _R.getversion().core + ")", "color:#c0392b;font-weight:bold;"),
            ...
            console.log("%c     It might be required to purge and clear Server/Client side Caches.", "color:#333")),
            a.check = "stop")),
            b[a.alias] === undefined && (b[a.alias] = new Object,
        ...
        callingNewSlide: function(a, b) {
            ...
            b && jQuery.isNumeric(b) || b.match(/to/g) ? (1 === b || -1 === b ? (d = c + b,
    ...
    var _ISM = _R.is_mobile()
      ...
      , checkIDS = function(a, b) {
        if (a.anyid = a.anyid === undefined ? [] : a.anyid,
      ...
      , getNeededScripts = function(a, b) {
        ...
        c.navigation && void 0 === _R.createNavigation && lAjax("revolution.extension.navigation", a),
      ...
      , initSlider = function(container, opt) {
        ...
        opt.ul.find(">li").each(function(a) {
            ...
            (b.data("invisible") || !0 === b.data("invisible")) && (b.addClass("tp-invisible-slide"),
            b.appendTo(opt.ul))
        }),
        ...
        !a.hasClass("revslider-initialised")) {
            ...
            a.find(".tp-caption, .rs-background-video-layer").each(function(a) {
                ...
                c.hasClass("tp-caption")) {
                    ...
                    t = "rev_row_wrap") : "column" === r ? (q = o.verticalalign === undefined ? " vertical-align:bottom;" : " vertical-align:" + o.verticalalign + ";",
                    t = "rev_column",
                    ...
                    var u = ""
                      , v = "";
                    "row" !== r && "group" !== r && "column" !== r ? (u = "display:" + c.css("display") + ";",
                    ...
                    "column" === r && (c.append('<div class="rev_column_bg rev_column_bg_man_sized" style="visibility:hidden"></div>'),
                ...
                !_ISM || b.fallbacks.allowHTML5AutoPlayOnAndroid && g || (1 != e && "true" != e || (d.autoplayonlyfirsttime = !1,
                e = !1),
            ...
            var s = b.viewPort;
            b.inviewport = !1,
            s != undefined && s.enable && (jQuery.isNumeric(s.visible_area) || -1 !== s.visible_area.indexOf("%") && (s.visible_area = parseInt(s.visible_area) / 100),
            ...
            hideSliderUnder(a, b),
            contWidthManager(b),
            b.fallbacks.disableFocusListener || "true" == b.fallbacks.disableFocusListener || !0 === b.fallbacks.disableFocusListener || (a.addClass("rev_redraw_on_blurfocus"),
            tabBlurringCheck())
        }
    }
      , cArray = function(a, b) {
      ...
      , waitForCurrentImages = function(a, b, c) {
        ...
        jQuery.each(b.loadqueue, function(a, b) {
            !0 !== b.static || "loaded" == b.progress && "failed" !== b.progress || ("failed" == b.progress ? b.reported || (b.reported = !0,
      ...
      , swapSlide = function(a) {
        ...
        d.index() === c.index() && !0 !== b.onlyPreparedSlide)
            return d.removeClass("next-revslide"),
            !1;
        !0 === b.onlyPreparedSlide && (b.onlyPreparedSlide = !1,
      ...
      , swapSlideProgress = function(a, b) {
        ...
        _R.scrollHandling && (_R.scrollHandling(g, !0, 0),
      ...
      , letItFree = function(a, b, c, d, e, f) {
        ...
        g.startWithSlide !== undefined && "done" !== g.startWithSlide && "carousel" === g.sliderType) {
      ...
      , restartOnFocus = function() {
        jQuery(".rev_redraw_on_blurfocus").each(function() {
            ...
            if (a == undefined || a.c == undefined || 0 === a.c.length)
                return !1;
            1 != a.windowfocused && (a.windowfocused = !0,
      ...
      , tabBlurringCheck = function() {
        ...
        a && !b ? jQuery(window).on("focusin", function() {
            restartOnFocus()
