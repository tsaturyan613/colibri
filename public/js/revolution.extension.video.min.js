...
!function(a) {
    ...
    jQuery.extend(!0, b, {
        ...
        playVideo: function(a, c) {
            ...
            case "youtube":
                if (0 == a.find("iframe").length)
                    ...
                    1 == a.data("nextslideatend-triggered") && (h = -1,
            ...
            case "html5":
                ...
                if (1 != m.parent().data("metaloaded"))
                    g(n, "loadedmetadata", function(a) {
                        b.resetVideo(a, c),
                        n.play();
                        var d = f(a.data("videostartat"))
                          , e = n.currentTime;
                        1 == a.data("nextslideatend-triggered") && (e = -1,
                        a.data("nextslideatend-triggered", 0)),
        ...
        manageVideoLayer: function(a, d, h, j) {
            ...
            switch (w = !0 === k.nextslideatend ? "" : w,
            k.videotype = x,
            z) {
            case "html5":
                "controls" != u && (u = "");
                var y = "video";
                "html5" == k.audio && (y = "audio",
                ...
                void 0 != r && "firefox" == b.get_browser().toLowerCase() && (B = B + '<source src="' + r + '" type="video/webm" />'),
                void 0 != q && (B = B + '<source src="' + q + '" type="video/mp4" />'),
                void 0 != s && (B = B + '<source src="' + s + '" type="video/ogg" />'),
                B = B + "</" + y + ">";
                var C = "";
                ...
                a.find(y).each(function(c) {
                    ...
                    1 != f.parent().data("metaloaded") && g(e, "loadedmetadata", function(a) {
                        l(a, d),
                        b.resetVideo(a, d)
                    }(a))
                });
            ...
            case "youtube":
                ...
                -1 == m.toLowerCase().indexOf("controls") && (m += "&controls=0")),
                !0 !== k.videoinline && "true" !== k.videoinline && 1 !== k.videoinline || (m += "&playsinline=1");
                var D = f(a.data("videostartat"))
                ...
                var F = m.split("origin=" + v + "://")
                  , G = "";
                F.length > 1 ? (G = F[0] + "origin=" + v + "://",
                self.location.href.match(/www/gi) && !F[1].match(/www/gi) && (G += "www."),
                G += F[1]) : G = m;
    ...
    var g = function(a, b, c) {
      ...
      , i = function(a, d, e) {
        ...
        1 == a.data("forcecover")) {
            ...
            void 0 != q && q.split(":").length > 1 && (console.log("i"),
            b.prepareCoveredVideo(q, d, a))
        }
        if (1 == a.data("bgvideo")) {
            var q = a.data("aspectratio");
            void 0 != q && q.split(":").length > 1 && (console.log("ak"),
            b.prepareCoveredVideo(q, d, a))
        }
        if (i.attr("id", l),
        ...
        1 !== a.data("videolistenerexist"))
            ...
            case "youtube":
                    ...
                    events: {
                        onStateChange: function(c) {
                            ...
                            if (c.data == YT.PlayerState.PLAYING)
                                ...
                                "mute" == a.data("volume") || b.lastToggleState(a.data("videomutetoggledby")) || !0 === d.globalmute ? r.mute() : (r.unMute(),
                                r.setVolume(parseInt(a.data("volume"), 0) || 75)),
                                d.videoplaying = !0,
                                m(a, d),
                                p ? d.c.trigger("stoptimer") : d.videoplaying = !1,
                                d.c.trigger("revolution.slide.onvideoplay", h(r, "youtube", a.data())),
                                ...
                                -1 != c.data && 3 != c.data && (d.videoplaying = !1,
                                d.tonpause = !1,
                                n(a, d),
                                e.trigger("starttimer"),
                                d.c.trigger("revolution.slide.onvideostop", h(r, "youtube", a.data())),
                                void 0 != d.currentLayerVideoIsPlaying && d.currentLayerVideoIsPlaying.attr("id") != a.attr("id") || b.unToggleState(g.videotoggledby)),
                                0 == c.data && 1 == a.data("nextslideatend") ? (j(),
                ...
                break;
            case "vimeo":
                for (var w, s = i.attr("src"), t = {}, u = s, v = /([^&=]+)=([^&]*)/g; w = v.exec(u); )
                ...
                y.addEvent("ready", function() {
                    ...
                    y.addEvent("play", function(c) {
                        ...
                        d.c.trigger("revolution.slide.onvideoplay", h(y, "vimeo", a.data())),
                        d.videoplaying = !0,
                        m(a, d),
                        p ? d.c.trigger("stoptimer") : d.videoplaying = !1,
                        "mute" == a.data("volume") || b.lastToggleState(a.data("videomutetoggledby")) || !0 === d.globalmute ? y.api("setVolume", "0") : y.api("setVolume", parseInt(a.data("volume"), 0) / 100 || .75),
                        b.toggleState(g.videotoggledby)
                    }),
                    ...
                    y.addEvent("finish", function(c) {
                        ...
                        d.c.trigger("revolution.slide.onvideostop", h(y, "vimeo", a.data())),
                        1 == a.data("nextslideatend") && (a.data("nextslideatend-triggered", 1),
                        d.c.revnext()),
                        void 0 != d.currentLayerVideoIsPlaying && d.currentLayerVideoIsPlaying.attr("id") != a.attr("id") || b.unToggleState(g.videotoggledby)
                    }),
      ...
      , l = function(a, e, i) {
        ...
        if (s = "loop" == s || "loopandnoslidestop" == s,
        r.data("metaloaded", 1),
        1 != a.data("bgvideo") || "none" !== l.videoloop && !1 !== l.videoloop || (t = !1),
        void 0 == p.attr("control") && (0 != a.find(".tp-video-play-button").length || c || a.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'),
        ...
        g(q, "timeupdate", function() {
            var b = 100 / q.duration * q.currentTime
              ...
              , d = q.currentTime;
            if (void 0 != y && (y.value = b),
            0 != c && -1 != c && Math.abs(c - d) <= .3 && c > d && 1 != a.data("nextslidecalled"))
                if (s) {
                    q.play();
        ...
        g(q, "play", function() {
            ...
            d || (!0 === e.globalmute ? q.muted = !0 : q.muted = !1,
            c > 1 && (c /= 100),
            "mute" == c ? q.muted = !0 : void 0 != c && (q.volume = c)),
            a.addClass("videoisplaying");
            var f = "html5" == l.audio ? "audio" : "video";
            m(a, e),
            t && "audio" != f ? (e.videoplaying = !0,
            e.c.trigger("stoptimer"),
            e.c.trigger("revolution.slide.onvideoplay", h(q, "html5", l))) : (e.videoplaying = !1,
        ...
        g(q, "pause", function(c) {
            ...
            void 0 != e.currentLayerVideoIsPlaying && e.currentLayerVideoIsPlaying.attr("id") != a.attr("id") || b.unToggleState(l.videotoggledby)
        }),
        g(q, "ended", function() {
            j(),
            n(a, e),
            ...
            e.c.trigger("revolution.slide.onvideostop", h(q, "html5", a.data())),
            !0 === a.data("nextslideatend") && q.currentTime > 0 && (1 == !e.just_called_nextslide_at_htmltimer && (a.data("nextslideatend-triggered", 1),
            e.c.revnext(),
            e.just_called_nextslide_at_htmltimer = !0),
            setTimeout(function() {
                e.just_called_nextslide_at_htmltimer = !1
